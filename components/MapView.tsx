...
export const MapView: React.FC<MapViewProps> = ({ companies, onSelectCompany, currentReligion, onSearchArea, center, onToggleSettings }) => {
  const { userLocation, setUserLocation, searchRadius, setSearchRadius } = useApp();
  ...
  return (
    <div className="w-full h-full absolute inset-0 bg-slate-100">
      ...
      {/* Search Here Button */}
      {showSearchButton && (
          <div className="absolute top-[15vh] md:top-20 left-1/2 transform -translate-x-1/2 z-[400] animate-in fade-in slide-in-from-top-4 duration-300">
              <button 
      ...
      {/* Floating search bar, Religion Badge and Radius Slider */}
