...
import { Calendar, MapPin, Share2, AlertTriangle } from 'lucide-react';
...
export default function FeedPostCard({ post }: FeedPostCardProps) {
  ...
  return (
    <>
      ...
      {/* Report Dialog */}
      {isReportDialogOpen && (
        <ReportPostDialog postId={post._id} onClose={handleCloseReportDialog} />
      )}
    </>
  );
}
